...
function initBootSequence(callback) {
  ...
  const bootLines = [
    ...
    "  USB Controller 1-1.. OK",
    "  USB Controller 1-2.. OK",
    "  USB Controller 2-1.. OK",
    "  USB 3.0 Controller.. OK",
    "Done.",
    "",
    "Memory Test:",
    "  Bank 0: 16384MB OK",
    ...
    "",
    "Loading Onyx BSD Kernel v5.18.41-sec...",
    "[    0.000000] Linux version 5.18.41-sec (root@onyx-node-07)",
    "[    0.000001] Command line: BOOT_IMAGE=/vmlinuz-5.18.41-sec root=/dev/mapper/root ro quiet",
    "[    0.000002] x86/fpu: x87 FPU detected",
    "[    0.000003] Disabled lock debugging during boot",
    "[    0.000004] ACPI: DSDT 00000000000A0000",
    "[ OK ] Started Show Plymouth Boot Screen.",
    "[    0.000005] ACPI: Core revision 20190803",
    "[ OK ] Reached target Paths.",
    "[    0.000006] systemd[1]: Detaching real cgroup /sys/fs/cgroup/systemd",
    "[ OK ] Reached target Basic System.",
    "[    0.000007] ACPI: Added _OSI(Windows 2015)",
    "[ OK ] Found device /dev/mapper/root.",
    "[    0.000008] ACPI: 16 ACPI AML tables successfully loaded",
    "[ OK ] Started File System Check on /dev/mapper/root.",
    "[    0.000009] ACPI: DSDT 00000000000A0000",
    "[    0.000010] cryptsetup: root set up successfully",
    "[    0.000011] ACPI: SSDT 00000000000A0000",
    "Mounting /sys/kernel/security...",
    "Mounting /sys/fs/cgroup...",
    "[    0.000012] thermal_system: registered as thermal_zone0",
    "[ OK ] Started Dispatch Password Requests to Console Directory Watch.",
    "[    0.000013] systemd-journald[89]: Journal started",
    "[ OK ] Started Remount Root and Kernel File Systems.",
    "[    0.000014] audit: initializing netlink socket",
    "[    0.000015] systemd[1]: Hostname set to <onyx-node-07>",
    "[    0.000016] i8042: PNP: No PS/2 controller found.",
    "[ OK ] Reached target Local Encrypted Volumes.",
    "[    0.000017] systemd[1]: Configuration file /etc/systemd/system.conf",
    "[ OK ] Started Forward Password Requests to Wall Directory Watch.",
    "[    0.000018] audit: type=1400 audit(1737189771.002:2):",
    "[ OK ] Reached target Remote File Systems.",
    "[    0.000019] systemd[1]: Listening on /run/systemd/notify",
    "[ OK ] Reached target System Initialization.",
    "[    0.000020] IPv6: ADDRCONF(NETDEV_CHANGE): eth0",
    "[    0.000021] systemd-networkd[100]: eth0: Gained carrier",
    "Starting Security Monitoring System v2.4.1...",
    "[ OK ] Started Network Service.",
    "Initializing Network Interfaces...",
    "  eth0: 192.168.1.100/24",
    "  gateway: 192.168.1.1",
    "  dns: 8.8.8.8 8.8.4.4",
    "[ OK ] Interface configuration complete.",
    "Establishing Secure Uplink...",
    "  Encryption: AES-256-GCM",
    "  Tunnel: WireGuard",
    "  Endpoint: jp-east-1.nexus-relay.net",
    "[ OK ] Connection established.",
    "Loading system modules...",
    "[ OK ] Loaded: nexus-core, threat-detection, packet-analyzer",
    "[ OK ] Loaded: hex-dumper, spectrum-analyzer, matrix-rain",
    "[ OK ] Loaded: radar-sonar, defragmenter, data-stream",
    "[ OK ] All modules loaded successfully.",
    "Starting background services...",
    "[ OK ] nexus-monitor.service",
    "[ OK ] threat-detection.service",
    "[ OK ] network-visualizer.service",
    "[ OK ] All services started.",
    "",
    "ACCESS GRANTED.",
    "Welcome to Nexus Terminal v2.4.1"
  ];

  let lineIndex = 0;
  const speed = 20; // ms per line (faster)
